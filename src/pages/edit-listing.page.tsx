...
const EditListingPage = () => {
    ...
    useEffect(() => {
        setIsLoading(true)
        ;(async () => {
            const response = await getDocument('listings', listingID!)
            ...
            if (response.creatorID !== auth.currentUser?.uid) {
                toast.error('امکان ویرایش این آکهی وجود ندارد.')
                return
            }
    ...
    const onSubmit = async (e: any) => {
        ...
        const status = await updateListing(listingID!, dataToSend)
    ...
    return (
        <>
            <div className="profile">
                <header>
                    <p className="pageHeader">ویرایش آگهی</p>
                </header>
